<!-- apps/echadron-web/src/components/ServerAuthDialog.vue -->
    ...
    <div class="server-auth-card">
      <div class="server-auth-head">
        ...
        <p class="server-auth-hint">
          ...
          started (or the password set via <code>ECHADRON_CODE_PASSWORD</code> or
          legacy <code>KIMI_CODE_PASSWORD</code>).
        </p>
      </div>
