<!-- apps/echadron-web/src/components/settings/Onboarding.vue -->
...
<template>
  ...
  >
    <template #head>
      <div class="ob-brand">
        <svg class="ob-logo" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Echadron">
          <defs>
            <mask id="obEchadronMark" maskUnits="userSpaceOnUse">
          ...
          <rect x="1" y="1" width="30" height="20" rx="6" fill="var(--color-accent)" mask="url(#obEchadronMark)" />
        </svg>
