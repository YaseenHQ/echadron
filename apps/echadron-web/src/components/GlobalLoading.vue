<!-- apps/echadron-web/src/components/GlobalLoading.vue -->
<!-- Full-screen splash shown on first load until the client has talked to the
     ...
     app. Hidden once the web client has initialized. The product mark uses
     currentColor so it remains theme-aware. -->
  ...
  <div class="gload" role="status" :aria-label="t('app.connecting')">
    <div class="gload-box">
      <svg class="gload-logo" viewBox="0 0 96 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <rect x="32" y="1" width="30" height="30" rx="8" fill="currentColor" opacity="0.14" />
        <path fill="currentColor" d="M40 7h16v4H45v4h10v4H45v4h11v4H40z" />
        <path fill="currentColor" d="M68 8h4v16h-4zM76 8h4v16h-4z" opacity="0.58" />
      </svg>
