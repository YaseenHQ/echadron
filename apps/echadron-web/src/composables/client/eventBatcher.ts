// apps/echadron-web/src/composables/client/eventBatcher.ts
...
// tested directly. See useEchadronWebClient.ts for the WS pipeline wiring.

import type { AppEvent, EchadronEventMeta } from '../../api/types';
