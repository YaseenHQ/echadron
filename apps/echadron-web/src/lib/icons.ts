// apps/echadron-web/src/lib/icons.ts
// Single source of truth for apps/echadron-web icons (design-system §02).
//
...
//   - `~icons/echadron/*` — Echadron Design System icons (24×24 outlined,
//     fill="currentColor"), local SVGs under src/icons/echadron/ registered as a
//     custom collection in vite.config.ts. Preferred when an Echadron icon exists
//     for the intent.
...
// Components (Echadron collection) ----------------------------------------------
import EchadronAddConversation from '~icons/echadron/add-conversation';
import EchadronFolder from '~icons/echadron/folder';
import EchadronFolderOpen from '~icons/echadron/folder-open';
import EchadronMore from '~icons/echadron/more';
import EchadronSearch from '~icons/echadron/search';
import EchadronSetting from '~icons/echadron/setting';
...
// Raw SVG strings (Echadron collection) -----------------------------------------
import RawEchadronAddConversation from '~icons/echadron/add-conversation?raw';
import RawEchadronFolder from '~icons/echadron/folder?raw';
import RawEchadronFolderOpen from '~icons/echadron/folder-open?raw';
import RawEchadronMore from '~icons/echadron/more?raw';
import RawEchadronSearch from '~icons/echadron/search?raw';
import RawEchadronSetting from '~icons/echadron/setting?raw';
...
export const ICONS: Record<IconName, IconEntry> = {
  ...
  'chat-new': entry(EchadronAddConversation, RawEchadronAddConversation),
  ...
  search: entry(EchadronSearch, RawEchadronSearch),
  ...
  settings: entry(EchadronSetting, RawEchadronSetting),
  ...
  folder: entry(EchadronFolderOpen, RawEchadronFolderOpen),
  'folder-closed': entry(EchadronFolder, RawEchadronFolder),
  ...
  'dots-horizontal': entry(EchadronMore, RawEchadronMore),
};
