// apps/echadron-web/src/api/config.ts
...
export interface EchadronApiConfig {
...
function serverHttpEnv(): string | undefined {
  return import.meta.env.VITE_ECHADRON_SERVER_HTTP_URL;
}

export function readEchadronApiConfig(): EchadronApiConfig {
  return {
