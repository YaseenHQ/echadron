// apps/echadron-web/src/api/daemon/client.ts
// DaemonEchadronWebApi — implements EchadronWebApi using the daemon REST + WS APIs.

import type { EchadronApiConfig } from '../config';
...
// ---------------------------------------------------------------------------
// DaemonEchadronWebApi
// ---------------------------------------------------------------------------

export class DaemonEchadronWebApi implements EchadronWebApi {
  private readonly http: DaemonHttpClient;
  private readonly config: EchadronApiConfig;

  constructor(config: EchadronApiConfig) {
    this.config = config;
