...
// Run: pnpm --filter @yaseenhq/echadron-web exec vitest run test/workspace-state.test.ts
...
import type { ExtendedState } from '../src/composables/useEchadronWebClient';
