...
| `surfaceTool` | Tool execution panel background — neutral surface grouping each tool call |
| `surfaceToolSuccess` | Tool panel background on success — slight success tint |
| `surfaceToolError` | Tool panel background on error — slight error tint |
| `surfaceUser` | User message background — distinguishes user input from assistant output |
