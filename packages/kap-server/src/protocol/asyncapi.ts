...
const DEFAULT_TITLE = 'Echadron WebSocket API';
...
export function createAsyncApiDocument(
  ...
  return {
    ...
    info: {
      ...
      version,
      description:
        'WebSocket protocol for Echadron daemon control frames, acknowledgements, system frames, and session event streaming.',
    },
    ...
    servers: {
      local: {
        ...
        pathname: wsPath,
        description: 'Echadron daemon WebSocket endpoint.',
      },
    },
    channels: {
      [CHANNEL_ID]: {
