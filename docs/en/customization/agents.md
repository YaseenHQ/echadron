...
| `model` | no | Concrete configured model alias used when this profile is launched as a sub-agent. Omit it or use `inherit` to continue through the normal primary/secondary selection |
