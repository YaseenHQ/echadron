...
Echadron CLI supports three MCP server connection methods:
...
::: warning Note
stdio entries in a project-level `.echadron/mcp.json` execute local commands when a session starts. Only enable these in repositories you trust.
:::
